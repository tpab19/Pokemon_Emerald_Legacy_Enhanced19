...
#define PARTY_MSG_CHOOSE_MON_SEL_MOVE       15 // Originally used by Daycare only, swapped for Select to Move and changed Daycare to use original Choose Mon string
...
#define PARTYBOX_DESC_ITEM_DENY   13
