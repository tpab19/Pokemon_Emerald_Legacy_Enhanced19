...
#define OPTIONS_BUTTON_MODE_L_EQUALS_A 1 // Swapped L=A and LR Mode to allow LR Mode to work on new settings
#define OPTIONS_BUTTON_MODE_LR 2
#define OPTIONS_BUTTON_MODE_L_EQUALS_SETTINGS 3
#define OPTIONS_BUTTON_MODE_L_EQUALS_OVERWORLD_SPEED 4
#define OPTIONS_BUTTON_MODE_L_EQUALS_OVERWORLD_SPEED_2X 5
#define OPTIONS_BUTTON_MODE_L_EQUALS_OVERWORLD_SPEED_4X 6
#define OPTIONS_BUTTON_MODE_L_EQUALS_OVERWORLD_SPEED_8X 7
#define OPTIONS_BUTTON_MODE_L_EQUALS_FASTMODE 8
#define OPTIONS_BUTTON_MODE_L_EQUALS_FOLLOWER 9
