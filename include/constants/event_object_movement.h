...
#define MOVEMENT_ACTION_JUMP_SPECIAL_IN_PLACE_DOWN              0x9E
#define MOVEMENT_ACTION_JUMP_SPECIAL_IN_PLACE_UP                0x9F
#define MOVEMENT_ACTION_JUMP_SPECIAL_IN_PLACE_LEFT              0xA0
#define MOVEMENT_ACTION_JUMP_SPECIAL_IN_PLACE_RIGHT             0xA1
#define MOVEMENT_ACTION_JUMP_SPECIAL_IN_PLACE_DOWN_UP           0xA2
#define MOVEMENT_ACTION_JUMP_SPECIAL_IN_PLACE_UP_DOWN           0xA3
#define MOVEMENT_ACTION_JUMP_SPECIAL_IN_PLACE_LEFT_RIGHT        0xA4
#define MOVEMENT_ACTION_JUMP_SPECIAL_IN_PLACE_RIGHT_LEFT        0xA5
#define MOVEMENT_ACTION_EXIT_POKEBALL                   0xA6
