...
static void HallOfFame_PrintPlayerInfo(u8 unused1, u8 unused2)
{
    ...
    {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 12, 1, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_LegacyHardcore);
    }
    else if (FlagGet(FLAG_HARD))
    {
        AddTextPrinterParameterized3(1, FONT_NORMAL, 24, 1, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_LegacyHard);
    }
    else
    {
    ...
    AddTextPrinterParameterized3(1, FONT_NORMAL, 31, 0x11, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Enhanced);
    AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x21, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Name);

    width = GetStringRightAlignXOffset(FONT_NORMAL, gSaveBlock2Ptr->playerName, 0x70);
    AddTextPrinterParameterized3(1, FONT_NORMAL, width, 0x21, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gSaveBlock2Ptr->playerName);

    trainerId = (gSaveBlock2Ptr->playerTrainerId[0]) | (gSaveBlock2Ptr->playerTrainerId[1] << 8);
    AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x31, sPlayerInfoTextColors, 0, gText_IDNumber);
    ...
    AddTextPrinterParameterized3(1, FONT_NORMAL, 0, 0x41, sPlayerInfoTextColors, TEXT_SKIP_DRAW, gText_Time);
