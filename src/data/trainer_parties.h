...
static const struct TrainerMon sParty_Wattson4[] = {
    ...
    .heldItem = ITEM_CHOICE_BAND,
    .moves = {MOVE_HYPER_BEAM, MOVE_IRON_TAIL, MOVE_AERIAL_ACE, MOVE_PURSUIT}
    },
    {
    .iv = 255,
    .lvl = 60,
...
static const struct TrainerMon sParty_Flannery2[] = {
    ...
    .species = SPECIES_RAPIDASH,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_JUMP_KICK, MOVE_IRON_TAIL, MOVE_DOUBLE_EDGE}
    },
    {
    .iv = 250,
    .lvl = 40,
...
static const struct TrainerMon sParty_Flannery5[] = {
    ...
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_OVERHEAT, MOVE_EXTREME_SPEED, MOVE_SUNNY_DAY, MOVE_ROAR}
    },
    {
    .iv = 255,
    .lvl = 65,
...
static const struct TrainerMon sParty_Norman2[] = {
    ...
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_SITRUS_BERRY,
    .moves = {MOVE_TAKE_DOWN, MOVE_BELLY_DRUM, MOVE_FACADE, MOVE_IRON_TAIL}
    },
    {
    .iv = 250, 
    .lvl = 50,
