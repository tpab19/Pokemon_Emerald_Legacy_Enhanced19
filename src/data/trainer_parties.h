...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_ROCK_TOMB, MOVE_CONSTRICT, MOVE_HARDEN, MOVE_NONE}
    },
    {
    .iv = 200,
    .lvl = 15,
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_FALSE_SWIPE, MOVE_MEGA_DRAIN, MOVE_BULK_UP, MOVE_STUN_SPORE}
    }
};
// Mauville Gym Leader
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_WISH, MOVE_HEAL_BELL, MOVE_HELPING_HAND, MOVE_PSYCHIC}
    },
    {
    .iv = 250,
    .lvl = 42,
...
static const struct TrainerMonItemCustomMoves sParty_Isabel1[] = {
    ...
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_MAGICAL_LEAF, MOVE_LIGHT_SCREEN, MOVE_QUICK_ATTACK}
    }
};
...
// Route 103 Twins
static const struct TrainerMonNoItemCustomMoves sParty_AmyAndLiv1[] = {
    {
    .iv = 0,
    .lvl = 18,
    .species = SPECIES_PLUSLE,
    ...
    .lvl = 18,
    .species = SPECIES_MINUN,
    {MOVE_THUNDER_SHOCK, MOVE_GROWL, MOVE_FLASH, MOVE_QUICK_ATTACK}
    }
};
...
// Magma Admin Mt Chimney (refer to flannery)
...
// Magma Leader Mt Chimney (refer to flannery)
...
static const struct TrainerMonNoItemCustomMoves sParty_TyraAndIvy[] = {
    ...
    .lvl = 25,
    .species = SPECIES_GRAVELER,
    .moves = {MOVE_DEFENSE_CURL, MOVE_MAGNITUDE, MOVE_MUD_SPORT, MOVE_ROCK_THROW}
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Kaleb[] = {
    ...
    .species = SPECIES_MINUN,
    .heldItem = ITEM_ORAN_BERRY,
    .moves = {MOVE_THUNDER_SHOCK, MOVE_MAGICAL_LEAF, MOVE_LIGHT_SCREEN, MOVE_HELPING_HAND}
    },
    {
    .iv = 0,
    .lvl = 16,
