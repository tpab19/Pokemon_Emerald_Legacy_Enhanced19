...
static const struct TrainerMon sParty_TateAndLiza1[] = {
    ...
    .heldItem = ITEM_NONE,
    .moves = {MOVE_PSYCHIC, MOVE_CALM_MIND, MOVE_WISH, MOVE_HEAL_BELL }
    },
    {
    .iv = 250,
    .lvl = 43,
...
static const struct TrainerMon sParty_Heidi[] = {
    ...
    .moves = {MOVE_ABSORB, MOVE_MUD_SLAP, MOVE_PURSUIT, MOVE_ROCK_TOMB}
    }
};
...
static const struct TrainerMon sParty_Becky[] = {
    ...
    .lvl = 27,
    .species = SPECIES_BALTOY,
    .moves = {MOVE_SAND_ATTACK, MOVE_RAPID_SPIN, MOVE_PSYBEAM, MOVE_DIG}
    },
    {
    .iv = 0,
    .lvl = 27,
...
static const struct TrainerMon sParty_WallyVR1[] = {
    ...
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_SHARP_BEAK,
    .moves = {MOVE_AERIAL_ACE, MOVE_EARTHQUAKE, MOVE_SUPERPOWER, MOVE_DRAGON_DANCE}
    },
    {
    .iv = 150,
    .lvl = 48,
...
static const struct TrainerMon sParty_Athena[] = {
    ...
    .species = SPECIES_TENTACRUEL,
    .heldItem = ITEM_NONE,
    .moves = {MOVE_SURF, MOVE_RAIN_DANCE, MOVE_SLUDGE, MOVE_NONE}
    },
    {
    .iv = 100,
    .lvl = 38,
