const u16 *const gLevelUpLearnsets[NUM_SPECIES] =
{
    ...
    [SPECIES_DEOXYS_SPEED] = sDeoxys_SpeedLevelUpLearnset,
    [SPECIES_DEOXYS_ATTACK] = sDeoxys_AttackLevelUpLearnset,
    [SPECIES_DEOXYS_DEFENSE] = sDeoxys_DefenseLevelUpLearnset,
