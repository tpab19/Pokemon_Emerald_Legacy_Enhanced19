...
#define SPECIES_OVERWORLD_PAL(species, pal) [SPECIES_##species] = {pal, SPECIES_##species}
#define SPECIES_OVERWORLD_SHINY_PAL(species, pal) [SPECIES_##species] = {pal, SPECIES_##species + SPECIES_SHINY_TAG}
