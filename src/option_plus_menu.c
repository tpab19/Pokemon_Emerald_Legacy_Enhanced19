...
static const u8 sText_Desc_BikeOff[]            = _("Disables the BIKE theme\nwhen using the BIKE.");
static const u8 sText_Desc_BikeOn[]             = _("Enables the BIKE theme\nwhen using the BIKE.");
...
static const u8 *const OptionTextDescription(void)
{
    ...
    case MENU_CUSTOM:
        ...
        //if (menuItem == MENUITEM_CUSTOM_BIKEMUSIC || menuItem == MENUITEM_CUSTOM_SURFMUSIC)
        //    selection = 0;
...
static void DrawChoices_BikeMusic(int selection, int y)
{
    bool8 active = CheckConditions(MENUITEM_CUSTOM_BIKEMUSIC);
    u8 styles[2] = {0};
    styles[selection] = 1;
