...
const u8 gText_EmeraldLegacyEnhanced[] = _("EMERALD LEGACY ENHANCED");
const u8 gText_LegacyHard[] = _("ENHANCED LEGACY HARD");
const u8 gText_LegacyHardcore[] = _("ENHANCED LEGACY HARDCORE");
...
const u8 gText_ExpAllTurnOn[] = _("Turned on the EXP. ALL.\pPOKéMON in party will now gain shared\nEXP. Points.{PAUSE_UNTIL_PRESS}");
const u8 gText_ExpAllTurnOff[] = _("Turned off the EXP. ALL.\pPOKéMON in party will no longer gain\nshared EXP. Points.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_TypeEffect[] = _("MOVE EFFECT");
