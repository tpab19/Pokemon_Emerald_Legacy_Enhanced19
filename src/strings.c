...
const u8 gText_SoftboiledCost[] = _("SOFTBOILED{CLEAR_TO 0x4E}16BP");
const u8 gText_SeismicTossCost[] = _("SEISMIC TOSS{CLEAR_TO 0x4E}24BP");
const u8 gText_DreamEaterCost[] = _("DREAM EATER{CLEAR_TO 0x4E}24BP");
const u8 gText_MegaPunchCost[] = _("MEGA PUNCH{CLEAR_TO 0x4E}24BP");
const u8 gText_MegaKickCost[] = _("MEGA KICK{CLEAR_TO 0x4E}48BP");
const u8 gText_BodySlamCost[] = _("BODY SLAM{CLEAR_TO 0x4E}48BP");
const u8 gText_RockSlideCost[] = _("ROCK SLIDE{CLEAR_TO 0x4E}48BP");
const u8 gText_CounterCost[] = _("COUNTER{CLEAR_TO 0x4E}48BP");
const u8 gText_ThunderWaveCost[] = _("THUNDER WAVE{CLEAR_TO 0x4E}48BP");
const u8 gText_SwordsDanceCost[] = _("SWORDS DANCE{CLEAR_TO 0x4E}48BP");
const u8 gText_DefenseCurlCost[] = _("DEFENSE CURL{CLEAR_TO 0x4E}16BP");
const u8 gText_SnoreCost[] = _("SNORE{CLEAR_TO 0x4E}24BP");
const u8 gText_MudSlapCost[] = _("MUD-SLAP{CLEAR_TO 0x4E}24BP");
const u8 gText_SwiftCost[] = _("SWIFT{CLEAR_TO 0x4E}24BP");
const u8 gText_IcyWindCost[] = _("ICY WIND{CLEAR_TO 0x4E}24BP");
const u8 gText_EndureCost[] = _("ENDURE{CLEAR_TO 0x4E}48BP");
const u8 gText_PsychUpCost[] = _("PSYCH UP{CLEAR_TO 0x4E}48BP");
const u8 gText_IcePunchCost[] = _("ICE PUNCH{CLEAR_TO 0x4E}48BP");
const u8 gText_ThunderPunchCost[] = _("THUNDERPUNCH{CLEAR_TO 0x4E}48BP");
const u8 gText_FirePunchCost[] = _("FIRE PUNCH{CLEAR_TO 0x4E}48BP");
