...
{
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_APICOT_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_MAX_REVIVE, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_GANLON_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_PETAYA_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_MAX_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_LIECHI_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_SALAC_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_MAX_REVIVE, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_MAGO_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_IAPAPA_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_MAX_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_WIKI_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_AGUAV_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_MAX_REVIVE, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_FIGY_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_APICOT_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_MAX_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_GANLON_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_PETAYA_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_MAX_REVIVE, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_LIECHI_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_SALAC_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_MAX_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_MAGO_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_IAPAPA_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_MAX_REVIVE, ITEM_BRIGHT_POWDER, ITEM_SHELL_BELL, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_WIKI_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_LEFTOVERS, ITEM_CHOICE_BAND, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_AGUAV_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_MAX_REVIVE, ITEM_SCOPE_LENS, ITEM_FOCUS_BAND, ITEM_MAX_REVIVE, ITEM_SACRED_ASH},
    {ITEM_HYPER_POTION, ITEM_FLUFFY_TAIL, ITEM_MAGO_BERRY, ITEM_MAX_ETHER, ITEM_LUM_BERRY, ITEM_REVIVE, ITEM_QUICK_CLAW, ITEM_KINGS_ROCK, ITEM_FULL_RESTORE, ITEM_MAX_ELIXIR},
};
...
static void InitPyramidBagItems(u8 lvlMode)
{
    ...
    AddPyramidBagItem(ITEM_FULL_RESTORE, 1);
    AddPyramidBagItem(ITEM_MAX_ELIXIR, 1);
}
