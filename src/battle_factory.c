...
static const u16 sInitialRentalMonRanges[][2] =
{
    ...
    {FRONTIER_MON_DELCATTY_1, FRONTIER_MON_CLOYSTER_1}, // 155 - 266
    ...
    {FRONTIER_MON_DUGTRIO_4,  FRONTIER_MON_CRAWDAUNT_3},  // 660 - 763
    {FRONTIER_MON_DUGTRIO_1, FRONTIER_MON_JIRACHI_4},  // 372 - 894

    // Open level
    {FRONTIER_MON_DUGTRIO_1, FRONTIER_MON_SLAKING_1}, // 372 - 467
    {FRONTIER_MON_DUGTRIO_1, FRONTIER_MON_SLAKING_2}, // 468 - 563
    {FRONTIER_MON_DUGTRIO_2, FRONTIER_MON_SLAKING_3}, // 564 - 659
    {FRONTIER_MON_DUGTRIO_3, FRONTIER_MON_CRAWDAUNT_3}, // 660 - 755
    {FRONTIER_MON_DUGTRIO_1, FRONTIER_MON_JIRACHI_4},  // 372 - 894
    {FRONTIER_MON_DUGTRIO_1, FRONTIER_MON_JIRACHI_4},  // 372 - 894
    {FRONTIER_MON_DUGTRIO_1, FRONTIER_MON_JIRACHI_4},  // 372 - 894
    {FRONTIER_MON_DUGTRIO_1, FRONTIER_MON_JIRACHI_4},  // 372 - 894
...
u32 GetAiScriptsInBattleFactory(void)
{
    ...
    else
    {
        ...
        if (gTrainerBattleOpponent_A == TRAINER_FRONTIER_BRAIN)
            return AI_SCRIPT_CHECK_BAD_MOVE | AI_SCRIPT_TRY_TO_FAINT | AI_SCRIPT_CHECK_VIABILITY | AI_SCRIPT_RISKY;
