...
} static const sTrainerClassesAndMusic[] =
{
    ...
    {TRAINER_CLASS_CHAMPION_STEVEN, TRAINER_ENCOUNTER_MUSIC_MALE},
};
...
static const u16 sPrizeListSunnyDay[]    = {ITEM_RARE_CANDY,       ITEM_SAFARI_BALL, ITEM_PP_UP, ITEM_ELIXIR, ITEM_ETHER, ITEM_RED_SHARD};
...
static const u16 sPrizeListElixir2[]     = {ITEM_PP_MAX,           ITEM_SAFARI_BALL, ITEM_PP_UP, ITEM_ELIXIR, ITEM_ETHER, ITEM_BLUE_SHARD};
static const u16 sPrizeListBrickBreak[]  = {ITEM_MASTER_BALL,      ITEM_SAFARI_BALL, ITEM_PP_UP, ITEM_ELIXIR, ITEM_ETHER, ITEM_YELLOW_SHARD};
...
static const u16 sPrizeListGigaDrain[]   = {ITEM_SACRED_ASH,       ITEM_SAFARI_BALL, ITEM_PP_UP, ITEM_ELIXIR, ITEM_ETHER, ITEM_GREEN_SHARD};
